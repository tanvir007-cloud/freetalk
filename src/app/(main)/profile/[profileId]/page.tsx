...
export async function generateMetadata({
  ...
  const structuredData = {
    ...
    image: profileUser.image || fallbackImage,
    url: profileUrl,
  };

  return {
    title: `${profileUser.name} | Freetalk - Connect with Friends`,
    description: `View ${profileUser.name}'s profile on Freetalk. Connect with friends, share updates, and explore content.`,
    keywords: `${profileUser.name}, Freetalk, social media, connect, friends`,
    openGraph: {
